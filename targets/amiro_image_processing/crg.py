...
class _CRG(Module):
    def __init__(self, platform, clk_freq):
        ...
        self.specials.pll = Instance(
            ...
            # (150MHz) sdram_half - sdram dqs adr ctrl --> 100 mhz
            o_CLKOUT2=unbuf_sdram_half_a, p_CLKOUT2_DUTY_CYCLE=.5, 
            p_CLKOUT2_PHASE=270., p_CLKOUT2_DIVIDE=p//2, # was 270 größer geht, kleiner nicht
            # (150MHz) off-chip ddr --> 100mhz
            o_CLKOUT3=unbuf_sdram_half_b, p_CLKOUT3_DUTY_CYCLE=.5,
            p_CLKOUT3_PHASE=250., p_CLKOUT3_DIVIDE=p//2, #was 250 kleiner geht, größer nicht
